...
import java.util.*;
import org.elevator.sim.Sim;
import org.elevator.sim.SimEvent;
...
public class Elevator {
        ...
        public void openDoors() {
                ...
                if (trans == 0 && pList.size() == 0) {
                        ...
                        if (this.getCurrentState().directionState == ElevatorState.DirectionState.GOINGUP) {
                                ...
                                System.out.println("weird state " + this.getCurrentState().directionState);
                        }
        ...
        public void update() {
                if (this.state.getPressedFloors().isEmpty()) {
                        ...
                        System.out.println("" + this.state.getPressedFloors().get(0).floorNumber);
                }
        }
